...
// Run this test and check with netstat if UDP zombie sockets remain
exports["testudpclose"] = function(assert, done) {
    // this.timeout(100000); 
