...
var getmessagehandler = function(sid) {
    return function(event) {
        ...
        if (msg.error)
            ...
            console.warn('errorMessage', JSON.stringify(msg.errorMessage))
            console.warn('allErrors', JSON.stringify(msg.allErrors))
            console.warn('errorMessage', msg.errorMessage)
            console.warn('allErrors', msg.allErrors)
