...
api.doTraceroute = function(callback, params, inc) {
    ...
    var sendwait = opt.sendwait || undefined;
    ...
    console.log('traceroute cmd', cmd)
    console.log('traceroute args', args)
    console.log('traceroute params', params)
    console.log('traceroute inc', inc)
